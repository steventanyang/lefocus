export const FONT_OPTIONS = [
  { id: "helvetica", name: "Helvetica", shortcut: "1", className: "font-helvetica" },
  { id: "inter", name: "Inter", shortcut: "2", className: "font-inter" },
  { id: "sf-pro", name: "SF Pro", shortcut: "3", className: "font-sf-pro" },
