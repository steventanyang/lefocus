...
export function AppleLogo({ className }: { className?: string }): React.ReactElement {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function shouldShowAppleLogo(bundleId: string, appName: string | null): boolean {
  return (
